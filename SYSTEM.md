...
**Denetim snapshot'ı:** 22 Eylül 2026 · teslim branch'i · yerel doğrulama: `npm run typecheck`, `npm test` **368/368** (35 suite), `npm run verify:pdf`, `npm run build`, `git diff --check`.
...
> (`docs/mmpi-audit/TEST_AUDIT.md`); 285 → 368 arası **yorum katmanı** testleridir,
> puanlama/OMR matematiği değişmedi.
...
| `npm test` | `tsx --test tests/*.test.ts`; OMR/scanner, draft, result safety, PDF, build, print, router, kayıt/Edge Function hata çevirisi, MMPI puanlama/yorum denetim kilitleri ve teşhis betiği sözleşmesi | **368/368 DOĞRULANDI** (35 suite; 21 Eylül snapshot'ında 285/285 idi) |
...
- **Test:** `npm test` **368/368 PASS** (35 suite).
