...
export const PERSONALITY_KEYS: Record<PersonalityScaleId, ScaleKey> = {
  ...
  AVD: {
    dogru: [86, 138, 201, 305, 321, 344, 368, 509],
...
export const SPECIAL_KEYS: Record<SpecialScaleId, ScaleKey> = {
  ...
  Es: {
    dogru: [2, 36, 51, 95, 109, 153, 174, 181, 187, 192, 208, 221, 231, 234, 253, 270, 355, 367, 380, 410, 421, 430, 458, 483, 488, 489, 494, 510, 513, 515, 525, 541, 544, 548, 554, 555, 559, 561],
    yanlis: [14, 22, 32, 33, 34, 43, 48, 58, 62, 82, 94, 100, 132, 140, 189, 209, 217, 236, 241, 244, 251, 261, 341, 344, 349, 359, 378, 384, 389, 420],
  },
  A: {
