...
## Sc (8) kod bloğu (s.146-148) — **9 VAR / 1 YOK**

| # | Kaynak başlığı | Sayfa | Kodda | Not |
|---|---|---|---|---|
| 1 | `81/18` | s.146 | **VAR** ✅ | kayıt `18/81` |
| 2 | `82/28` | s.146 | **VAR** ✅ | kayıt `28/82` |
| 3 | `83/38` | s.146 | **VAR** ✅ | kayıt `38/83` |
| 4 | `84/48` | s.146 | **VAR** ✅ | kayıt `48/84` |
| 5 | `85/58` | s.146 | **VAR** ✅ | kayıt `58/85` |
| 6 | `86/68` | s.146 | **VAR** ✅ | paranoid vadi sayısal koşulu eksik → CONFLICT-038 |
| 7 | `87/78` | s.146 | **VAR** ✅ | |
| 8 | **`8726/Yüksek 9`** | s.146 | **YOK** ❌ | "Ajite şizofren" → `'8726'`→`78/87` (kırpma) |
| 9 | `89/98` | s.147 | **VAR** ✅ | |
| 10 | `80/08` | s.148 | **VAR** ✅ | |
...
| Mf (s.121-126) | 10 | 9 | 1 |
| Pa (s.130-135) | 15 | 9 | 6 |
| Pt (s.137-142) | 16 | 15 | 1 |
| **Sc (s.143-148)** | **10** | **9** | **1** |
| **TOPLAM** | **141** | **103** | **40** |


## Ma (9) kod bloğu (s.152-153) — **9 VAR / 2 YOK** (özel konfigürasyon)

| # | Kaynak başlığı | Sayfa | Kodda | Not |
|---|---|---|---|---|
| 1 | **`Yüksek 9/Yüksek K Kodu`** | s.152 | **YOK** ❌ | özel konfig (CONFLICT-039) · OCR ilkini "Düşük K" okudu → SEMANTIC-SWAP |
| 2 | **`Yüksek 9/Düşük K Kodu`** | s.153 | **YOK** ❌ | narsisistik/eksibisyonist (CONFLICT-039) |
| 3 | `91/19` | s.153 | **VAR** ✅ | kayıt `19/91` |
| 4 | `92/29` | s.153 | **VAR** ✅ | kayıt `29/92` |
| 5 | `93/39` | s.153 | **VAR** ✅ | kayıt `39/93` |
| 6 | `94/49` | s.153 | **VAR** ✅ | kayıt `49/94` |
| 7 | `95/59` | s.153 | **VAR** ✅ | kayıt `59/95` |
| 8 | `96/69` | s.153 | **VAR** ✅ | kayıt `69/96` |
| 9 | `97/79` | s.153 | **VAR** ✅ | kayıt `79/97` |
| 10 | `98/89` | s.153 | **VAR** ✅ | kayıt `89/98` |
| 11 | `90/09` | s.153 | **VAR** ✅ | |
...
## Si (0) kod bloğu (s.157) — **11 VAR / 0 YOK**
...
| 8 | `08/80` | s.157 | **VAR** ✅ | |
| 9 | `09/90` | s.157 | **VAR** ✅ | |
| 10 | `049` | s.157 | **VAR** ✅ *(dolaylı)* | → `40/04` kaydına düşüyor; **özel metni yok** |
| 11 | `027(8)` | s.157 | **VAR** ✅ *(dolaylı)* | → `20/02` kaydına düşüyor; **özel metni yok** |

### 🎯 FİNAL KÜMÜLATİF KAPSAM (PHASE 9/10 — klinik kod seti TAMAMLANDI)
