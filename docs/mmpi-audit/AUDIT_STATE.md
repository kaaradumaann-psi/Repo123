...
| 14 | Tests | **IN_PROGRESS** · `mmpiPtBlock` **11/11 PASS** · `mmpiPaBlock` **14/14 PASS** · `mmpiPdBlock` **17/17 PASS** · `mmpiHyBlock` **16/16 PASS** · `mmpiDBlock` **16/16 PASS** · `mmpiHsBlock` **16/16 PASS** · `mmpiKeyIntegrity` **63/63 PASS** · `mmpiInterpretation` **54/54 PASS** · `aiInterpretation` **5/5 PASS** · `verify:pdf` PASS · `tsc` 0 · `build` PASS |

## Current position

Current book page:
**s.137-142 (Pt Bloğu Göçü TAMAMLANDI)** · Sıradaki: **s.143-148 (Sc Bloğu)**
