...
**Ayrıntılı Denetim Belgeleri:** `docs/mmpi-audit/` (AUDIT_STATE, SOURCE_FACTS, CONFLICTS, DECISIONS, CODE_CHANGES, TEST_AUDIT, AI_AUDIT)
...
|---|---|---|---|---|
| 1 | **Geçerlik Ölçekleri (?, L, F, K) Puanlama Anahtarları** | `src/scoring/mmpiKeys.ts` | Ceyhun & Oral (2003), Ek 9 (s.244-245); Hathaway & McKinley (1942) | ✅ DOĞRULANDI (P0 MATCH) |
| 2 | **10 Temel Klinik Ölçek Puanlama Anahtarları** (Hs, D, Hy, Pd, Mf, Pa, Pt, Sc, Ma, Si) | `src/scoring/mmpiKeys.ts` | Ceyhun & Oral (2003), Tablo 8–17 (s.63-158) & Ek 9 | ✅ DOĞRULANDI (P0 MATCH) |
| 3 | **Türk Yetişkin Normları (Tablo 30 / Ek 10)** (M, SD, K-düzeltme oranları) | `src/scoring/mmpiKeys.ts` (`TURKISH_NORMS`) | Savaşır (1981); Ceyhun & Oral (2003), Tablo 30 (s.191-195, s.257-260) | ✅ DOĞRULANDI (26/26 MATCH) |
| 4 | **Geçerlik Ölçekleri Ham ve T Bant Yorumları** (?, L, F, K) | `src/scoring/mmpiSource.ts` | Ceyhun & Oral (2003), Bölüm 3 (s.35-52) | ✅ DOĞRULANDI |
| 5 | **Geçerlik Konfigürasyonları (Şekil 8–22)** (V-profili, Ters-V, vb.) | `src/scoring/mmpiValidityConfigs.ts` | Ceyhun & Oral (2003), Bölüm 4 (s.53-62) | ✅ DOĞRULANDI |
...
| 11 | **Kritik Maddeler Listesi (39 Madde)** | `src/scoring/mmpiCritical.ts` | Ceyhun & Oral (2003), Ek 1 (s.201-209); Koss & Butcher (1973) | ✅ DOĞRULANDI (CHANGE-011) |
| 12 | **TR ve Dikkatsizlik Endeksleri** | `src/scoring/mmpiConsistency.ts` | Greene (1979, 1980); Gravitz & Gerton (1976) | ✅ DOĞRULANDI |
| 13 | **F–K Ayrım Endeksi** | `src/scoring/mmpiConsistency.ts` | Gough (1947, 1950) | ✅ DOĞRULANDI |
...
Tüm denetim adımları `docs/mmpi-audit/` dizininde 14 fazlık yapılandırılmış denetim protokolü ile belgelenmiştir:
...
- `TEST_AUDIT.md`: 498 adet birim ve entegrasyon testinin doğrulama dökümü.
